<form method="POST" action="{{ route('nlc-project1.nlcdangnhap') }}">
    @csrf
    ...
    <div class="form-group">
        ...
        <input type="password" id="nlcmatkhau_confirmation" name="nlcmatkhau_confirmation" class="form-control" required>
    </div>
